! function(a, b, c, d) {
    ...
    e.prototype = {
        ...
        fetchInputs: function() {
            ...
            if (b = -1 !== a.inArray(this.config.target.get(0).tagName, this.globals.valElements) ? this.config.target.val() : this.config.target.text(), !1 === this.config.singleDate && b.indexOf(this.config.dateSeparator) > 0 && "" !== b) {
                ...
                2 == c.length && moment(c[0], this.config.format).isValid() && moment(c[1], this.config.format).isValid() && (this.config.startDate = moment(c[0], this.config.format, this.config.locale), this.config.endDate = moment(c[1], this.config.format, this.config.locale), this.globals.firstValueSelected = !0)
            } else if (!0 === this.config.singleDate) {
                var d = b;
                "" !== d && moment(d, this.config.format).isValid() && (this.config.startDate = moment(d, this.config.format, this.config.locale), this.config.endDate = moment(d, this.config.format, this.config.locale), this.globals.firstValueSelected = !0)
            }
        ...
        drawUserInterface: function() {
            ...
            if (this.drawTimePickers(), this.drawFooter(), this.reDrawCells(), this.setViewport(), !1 === this.globals.startSelected)
        ...
        drawHeader: function() {
            var a = "<div class='calentim-header'><div class='calentim-header-start'><div class='calentim-header-start-day'></div><div class='calentim-header-start-date'></div><div class='calentim-header-start-weekday'></div></div>";
        ...
        updateInput: function(b, c) {
            this.isUpdateable() && (this.readTimeFromDisplay(), this.config.startDate && this.config.startDate.locale(this.config.locale), this.config.endDate && this.config.endDate.locale(this.config.locale), -1 !== a.inArray(this.config.target.get(0).tagName, this.globals.valElements) ? !1 === this.config.singleDate ? this.config.target.val(this.config.startDate.format(this.config.format) + this.config.dateSeparator + this.config.endDate.format(this.config.format)) : this.config.target.val(this.config.startDate.format(this.config.format)) : !1 === this.config.singleDate ? this.config.target.text(this.config.startDate.format(this.config.format) + this.config.dateSeparator + this.config.endDate.format(this.config.format)) : this.config.target.text(this.config.startDate.format(this.config.format)), this.globals.initComplete && (c || b) && this.config.onafterselect(this, this.config.startDate, this.config.endDate))
        },
        clearInput: function() {
        ...
        drawCalendarOfMonth: function(a) {
            ...
            var d = "<div class='calentim-calendar' data-month='" + a.month() + "'>",
                e = 0,
                f = "",
                g = "";
            this.config.enableMonthSwitcher && (f = " class='calentim-month-switch'"), this.config.enableYearSwitcher && (g = " class='calentim-year-switch'"), d += "<div class='calentim-title'><span><b" + f + ">" + a.format("MMMM") + "</b>&nbsp;<span" + g + ">" + a.year() + "</span></span></div>", d += "<div class='calentim-days-container'>";
            ...
            for (; e < 42;) {
                ...
                d += "<div class='" + (a.month() == c.month() ? "calentim-day" : "calentim-disabled") + "' data-value='" + i + "'><span>" + c.date() + "</span></div>", c.add(moment.duration({
                    days: 1
                })), e++
            }
        ...
        addTimePickerHours: function(b, c, d) {
            ...
            g += "<div class='calentim-hour-selected'>" + ("00" + c).slice(-2) + "</div>", g += "<div class='calentim-hour-selected-next'>" + ("00" + (c + 1)).slice(-2) + "</div>", f.append(g).data({
                value: c,
                min: c,
                max: d,
                step: 1
            }), a("<div class='calentim-timepicker-hour-arrows'><div class='calentim-timepicker-hours-up " + (this.config.reverseTimepickerArrows ? "calentim-direction-down" : "calentim-direction-up") + "'><i class='fa fa-arrow-up'></i></div><div class='calentim-timepicker-hours-down " + (this.config.reverseTimepickerArrows ? "calentim-direction-up" : "calentim-direction-down") + "'><i class='fa fa-arrow-down'></i></div></div>").appendTo(b)
        },
        addTimePickerMinutes: function(b, c) {
            var d = a("<div class='calentim-timepicker-minutes-wrapper'></div>").appendTo(b),
                e = a("<div class='calentim-timepicker-minutes'></div>").appendTo(d),
                f = "<div class='calentim-minute-selected-prev'>&nbsp;</div>";
            f += "<div class='calentim-minute-selected'>00</div>", f += "<div class='calentim-minute-selected-next'>01</divided>", e.append(f).data({
                value: 0,
                min: 0,
                max: 59 % c != 0 ? 59 - 59 % c : 59,
                step: c
            }), a("<div class='calentim-timepicker-minute-arrows'><div class='calentim-timepicker-minutes-up " + (this.config.reverseTimepickerArrows ? "calentim-direction-down" : "calentim-direction-up") + "'><i class='fa fa-arrow-up'></i></div><div class='calentim-timepicker-minutes-down " + (this.config.reverseTimepickerArrows ? "calentim-direction-up" : "calentim-direction-down") + "'><i class='fa fa-arrow-down'></i></div></div>").appendTo(b)
        },
        addTimePickerHourMinuteSeparator: function(b) {
            a("<div class='calentim-hour-minute-seperator'>:</div>").appendTo(b)
        },
        ...
        addTimePickerEvents: function() {
            var b = this,
                d = function(a) {
                    var c = a.parents(".calentim-timepicker").hasClass("calentim-timepicker-start") ? "start" : "end",
                        d = a.hasClass("calentim-timepicker-minutes-up") || a.hasClass("calentim-timepicker-minutes-down") ? "minute" : "hour",
                        e = a.hasClass("calentim-direction-up") ? "up" : "down",
                        f = b.timepickers.find(".calentim-timepicker-" + c + " .calentim-timepicker-" + d + "s"),
                        g = f.data();
                    if (g && g.hasOwnProperty("value")) {
                        switch (e) {
                            case "down":
                                g.value + g.step > g.max ? g.value = g.min : g.value += g.step;
                                break;
                            case "up":
                                g.value - g.step < g.min ? g.value = g.max : g.value -= g.step
                        }
                        f.data(g), f.find(".calentim-" + d + "-selected-prev").text(g.value - g.step < g.min ? ("00" + g.max).slice(-2) : ("00" + (g.value - g.step)).slice(-2)), f.find(".calentim-" + d + "-selected").text(("00" + g.value).slice(-2)), f.find(".calentim-" + d + "-selected-next").text(g.value + g.step > g.max ? ("00" + g.min).slice(-2) : ("00" + (g.value + g.step)).slice(-2)), b.input.is(":visible") && (b.updateInput(!1, !0), b.config.ondraw(b))
                    }
                };
            a(c).off("mousedown.calentim").on("mousedown.calentim", ".calentim-timepicker-minutes-up, .calentim-timepicker-minutes-down, .calentim-timepicker-hours-up, .calentim-timepicker-hours-down", function(c) {
                var e = this;
                b.globals.mouseTimer && clearInterval(b.globals.mouseTimer), d(a(e)), b.globals.mouseTimer = setInterval(function() {
                    d(a(e))
                }, 200)
            }).off("mouseup.calentim").on("mouseup.calentim", function(a) {
                b.globals.mouseTimer && clearInterval(b.globals.mouseTimer), b.globals.preventMouseClick = !0
            }).off("click.calentim").on("click.calentim", ".calentim-timepicker-minutes-up, .calentim-timepicker-minutes-down, .calentim-timepicker-hours-up, .calentim-timepicker-hours-down", function(c) {
                b.globals.preventMouseClick || d(a(this)), b.globals.preventMouseClick = !1
            }), this.timepickers.find(".calentim-timepicker-hours-wrapper, .calentim-timepicker-minutes-wrapper").off("mousewheel.calentim DOMMouseScroll.calentim").on("mousewheel.calentim DOMMouseScroll.calentim", function(c) {
                ...
                }), c.on("panmove", b.panThrottle(function(c) {
                    var e = a(c.target);
                ...
                a(this).addClass("calentim-ampm-selected").siblings().removeClass("calentim-ampm-selected"), b.updateInput(!1, !0), b.config.ondraw(b)
            })
        },
        ...
        restoreTimePickers: function() {
            this.globals.startTimeBackup && this.setStartTimeValue(parseInt(this.globals.startTimeBackup.format("hh"), 10), parseInt(this.globals.startTimeBackup.format("mm"), 10), this.globals.startTimeBackup.format("a")), !this.config.singleDate && this.globals.endTimeBackup && this.setEndTimeValue(parseInt(this.globals.endTimeBackup.format("hh"), 10), parseInt(this.globals.endTimeBackup.format("mm"), 10), this.globals.endTimeBackup.format("a"))
        },
        updateTimePickerDisplay: function() {
            if (this.timepickers !== d && null !== this.config.startDate && null !== this.config.endDate) {
                var a = moment(this.config.startDate).set({
                    ...
                    b = moment(this.config.endDate).set({
                ...
                if (12 == this.config.hourFormat) {
                    var j = a.format("hh mm a").split(" ");
                    c = parseInt(j[0], 10), h = j[2].toLowerCase();
                    var k = b.format("hh mm a").split(" ");
                    e = parseInt(k[0], 10), i = k[2].toLowerCase()
                }
                this.setStartTimeValue(c, f, h), this.setEndTimeValue(e, g, i)
            }
        },
        setStartTimeValue: function(a, b, c) {
            var d = this.timepickers.find(".calentim-timepicker-start"),
                e = d.find(".calentim-timepicker-hours");
            e.data("value", a);
            var f = e.data();
            f && f.hasOwnProperty("value") && (e.find(".calentim-hour-selected-prev").text(f.value - f.step < f.min ? ("00" + f.max).slice(-2) : ("00" + (f.value - f.step)).slice(-2)), e.find(".calentim-hour-selected").text(("00" + f.value).slice(-2)), e.find(".calentim-hour-selected-next").text(f.value + f.step > f.max ? ("00" + f.min).slice(-2) : ("00" + (f.value + f.step)).slice(-2)));
            var g = d.find(".calentim-timepicker-minutes");
            g.data("value", b), f = g.data(), f && f.hasOwnProperty("value") && (g.find(".calentim-minute-selected-prev").text(f.value - f.step < f.min ? ("00" + f.max).slice(-2) : ("00" + (f.value - f.step)).slice(-2)), g.find(".calentim-minute-selected").text(("00" + f.value).slice(-2)), g.find(".calentim-minute-selected-next").text(f.value + f.step > f.max ? ("00" + f.min).slice(-2) : ("00" + (f.value + f.step)).slice(-2))), null !== c && (d.find(".calentim-ampm-selected").removeClass("calentim-ampm-selected"), d.find(".calentim-timepicker-ampm-" + c).addClass("calentim-ampm-selected"))
        },
        setEndTimeValue: function(a, b, c) {
            var d = this.timepickers.find(".calentim-timepicker-end"),
                e = d.find(".calentim-timepicker-hours");
            e.data("value", a);
            var f = e.data();
            f && f.hasOwnProperty("value") && (e.find(".calentim-hour-selected-prev").text(f.value - f.step < f.min ? ("00" + f.max).slice(-2) : ("00" + (f.value - f.step)).slice(-2)), e.find(".calentim-hour-selected").text(("00" + f.value).slice(-2)), e.find(".calentim-hour-selected-next").text(f.value + f.step > f.max ? ("00" + f.min).slice(-2) : ("00" + (f.value + f.step)).slice(-2)));
        ...
        drawFooter: function() {
            if (!1 === this.config.singleDate && !0 === this.config.showFooter && !0 === this.config.showCalendars) {
                ...
                var a = this.input.find(".calentim-ranges");
                a.append("<i class='fa fa-retweet'></i><div class='calentim-range-header'>" + this.config.rangeLabel + "</div>");
                for (var b in this.config.ranges) a.append("<div class='calentim-range' data-id='" + b + "'>" + this.config.ranges[b].title + "</div>")
            }
            if (this.globals.isMobile && (!0 !== this.config.singleDate && !1 !== this.config.showFooter || this.input.append("<div class='calentim-filler'></div>")), (this.globals.isMobile && !this.config.inline || !this.globals.isMobile && !this.config.inline && this.config.showButtons) && (this.input.append("<div class='calentim-footer'></div>"), this.footer = this.input.find(".calentim-footer"), this.footer.append("<button type='button' class='calentim-cancel'>" + this.config.cancelLabel + "</button>"), this.footer.append("<button type='button' class='calentim-apply'>" + this.config.applyLabel + "</button>"), !1 === this.globals.firstValueSelected && !0 === this.config.startEmpty && void 0 !== this.footer)) {
                var c = void 0 === this.footer ? [] : this.footer.find(".calentim-apply");
        ...
        drawNextMonth: function(a) {
            if (a = a || b.event, a.target = a.target || a.srcElement, null === this.globals.swipeTimeout) {
                ...
                this.globals.swipeTimeout = setTimeout(function() {
                    ...
                    !0 === c.config.onbeforemonthchange(c, c.globals.currentDate.clone().startOfMonth(), "next") && (c.globals.currentDate.middleOfDay().add(1, "month"), c.reDrawCalendars(), c.config.onaftermonthchange(c, c.globals.currentDate.clone().startOfMonth())), c.calendars.get(0).scrollTop = a, c.globals.swipeTimeout = null
                }, 100)
            }
            this.stopBubbling(a)
        },
        drawPrevMonth: function(a) {
            if (a = a || b.event, a.target = a.target || a.srcElement, null === this.globals.swipeTimeout) {
                ...
                this.globals.swipeTimeout = setTimeout(function() {
                    var a = c.calendars.get(0).scrollTop;
                    !0 === c.config.onbeforemonthchange(c, c.globals.currentDate.clone().startOfMonth(), "prev") && (c.globals.currentDate.middleOfDay().subtract(1, "month"), c.reDrawCalendars(), c.config.onaftermonthchange(c, c.globals.currentDate.clone().startOfMonth())), c.calendars.get(0).scrollTop = a, c.globals.swipeTimeout = null
                }, 100)
            }
            this.stopBubbling(a)
        },
        cellClicked: function(c) {
            ...
            if (!1 === this.config.singleDate)
                if (!1 === this.globals.startSelected) {
                    null !== this.config.startDate && (this.globals.startDateBackup = this.config.startDate.clone()), this.config.startDate = e, this.config.endDate = null, this.globals.startSelected = !0, this.globals.endSelected = !1, this.readTimeFromDisplay();
        ...
        checkRangeContinuity: function() {
            ...
            for (var b = this, c = this.config.endDate.diff(this.config.startDate, "days"), d = moment(this.config.startDate), e = function(c) {
        ...
        isDisabled: function(a) {
            var b = moment(a);
            if (!0 === this.config.disableDays(b.middleOfDay())) return !0;
        ...
        reDrawCalendars: function() {
            this.backupTimePickers(), this.input.empty(), this.drawUserInterface(), this.restoreTimePickers();
        ...
        monthSwitchClicked: function() {
            if (!(this.calendars.find(".calentim-month-selector").length > 0)) {
                ...
                for (var c = a("<div class='calentim-month-selector'></div>").appendTo(this.calendars), d = this.globals.currentDate.get("month"), e = 0; e < 12; e++) c.append("<div class='calentim-ms-month" + (d == e ? " current" : "") + "' data-month='" + e + "'>" + (this.config.numericMonthSelector ? e + 1 : moment({
                    day: 15,
                    hour: 12,
                    month: e
                }).locale(this.config.locale).format("MMMM")) + "</div>");
                c.css("display", "block"), this.optimizeFontSize(c.find(".calentim-ms-month")), c.find(".calentim-ms-month").off("click").on("click", function(c) {
                    b.globals.currentDate.month(a(this).data("month")), b.calendars.find(".calentim-month-selector").remove(), b.reDrawCalendars(), b.stopBubbling(c)
                })
            }
        },
        yearSwitchClicked: function() {
            if (!(this.calendars.find(".calentim-year-selector").length > 0)) {
                ...
                d.append("<div class='calentim-ys-year-next'><i class='fa fa-angle-double-right'></i></div>"), d.css("display", "block"), this.optimizeFontSize(d.find(".calentim-ys-year")), a(c).off("click.calentimys").on("click.calentimys", ".calentim-ys-year", function(c) {
                    b.globals.currentDate.year(a(this).data("year")), b.calendars.find(".calentim-year-selector").remove(), b.reDrawCalendars(), b.stopBubbling(c)
                }), a(c).off("click.calentimysprev").on("click.calentimysprev", ".calentim-ys-year-prev", function(a) {
        ...
        optimizeFontSize: function(c) {
            c.each(function(c, d) {
                ...
                if (e.innerHeight() === f.innerHeight()) f.remove(), e.contents().unwrap();
                    ...
                    for (loopCount = 0; e.innerHeight() !== f.innerHeight() && loopCount < 16;) {
                        var g = 0;
                        if (g = void 0 !== b.getComputedStyle ? parseFloat(b.getComputedStyle(f.get(0), null).getPropertyValue("font-size")) : parseFloat(f.css("font-size")), e.parent().css("font-size", g - 1 + "px"), f.css("font-size", g - 1 + "px"), g < 2) break;
                        loopCount++
                    }
        ...
        showDropdown: function(c) {
            return c = c || b.event, c.target = c.target || c.srcElement, (!this.globals.isMobile && "none" == this.container.css("display") || this.globals.isMobile && "none" == this.input.css("display")) && (c.target !== this.elem && (this.globals.dontHideOnce = !0, this.globals.initiator = c.target), null !== this.config.startDate && (this.globals.startDateInitial = this.config.startDate.clone()), null !== this.config.endDate && (this.globals.endDateInitial = this.config.endDate.clone()), this.fetchInputs(), (!1 === this.config.startEmpty || this.globals.firstValueSelected) && (this.globals.currentDate = moment(this.config.startDate)), this.reDrawCalendars(), this.config.onbeforeshow(this), this.globals.isMobile ? (this.input.css({
                display: "flex"
            }), a("body").addClass("calentim-open")) : this.container.css({
                display: "block"
            }), this.setViewport(), this.config.onaftershow(this)), !1
        },
        hideDropdown: function(c) {
            if (null === c || (c = c || b.event, c.target = c.target || c.srcElement, this.globals.initiator !== c.target)) return !1 === this.config.inline && (!this.globals.isMobile && "none" !== this.container.css("display") || this.globals.isMobile && "none" !== this.input.css("display")) && (this.config.onbeforehide(this), this.globals.isMobile ? (this.input.css({
                display: "none"
            }), a("body").removeClass("calentim-open")) : this.container.css({
                display: "none"
        ...
        addDisabledStyles: function(b, c, d, e, f, g) {
            ...
            return (j || null !== g && d > g || null !== f && d < f) && (e = " calentim-disabled", j && (e += " calentim-disabled-range")), c.month() != b.closest(".calentim-calendar").data("month") && (e += " calentim-disabled calentim-not-in-month", e = e.replace("calentim-weekend", "").replace(/  /g, " ")), e
        },
        rangeClicked: function(c) {
            if (c = c || b.event, c.target = c.target || c.srcElement, !1 === a(c.target).hasClass("calentim-range") && (c.target = a(c.target).closest(".calentim-range").get(0)), c.target.hasAttribute("data-id")) {
        ...
        setViewport: function() {
            ...
            else if ("none" !== this.container.css("display")) switch (this.config.showOn) {
                case "top":
        ...
        positionOnBottom: function(a) {
            ...
            if (a) return d;
            this.container.css(d), this.container.children("div[class*='calentim-box-arrow-']").attr("class", "calentim-box-arrow-top")
        },
        positionOnLeft: function(a) {
            ...
            if (a) return e;
            this.container.css(e), this.container.children("div[class*='calentim-box-arrow-']").attr("class", "calentim-box-arrow-right")
        },
        positionOnRight: function(a) {
            ...
            if (a) return d;
            this.container.css(d), this.container.children("div[class*='calentim-box-arrow-']").attr("class", "calentim-box-arrow-left")
        },
        positionOnTop: function(a) {
            ...
            if (a) return e;
            this.container.css(e), this.container.children("div[class*='calentim-box-arrow-']").attr("class", "calentim-box-arrow-bottom")
        },
        ...
        attachEvents: function() {
            ...
            if (this.container.find(".calentim-next").off(i).one(i, b), this.container.find(".calentim-prev").off(i).one(i, c), this.container.find(".calentim-day").off(i).on(i, d), this.container.find(".calentim-day").off("mouseover.calentim").on("mouseover.calentim", e), this.container.find(".calentim-disabled").not(".calentim-day").off(i), this.container.find(".calentim-range").off(i).on(i, f), this.container.find(".calentim-month-switch ").off(i).on(i, g), this.container.find(".calentim-year-switch ").off(i).on(i, h), !0 === this.globals.isMobile)
                ...
                }!this.globals.isMobile && !this.config.showButtons || this.config.inline || (this.input.find(".calentim-cancel").off("click.calentim").on("click.calentim", a.proxy(function(a) {
                this.config.startDate = this.globals.startDateInitial ? this.globals.startDateInitial.clone() : null, this.config.endDate = this.globals.endDateInitial ? this.globals.endDateInitial.clone() : null, this.config.startEmpty && !this.globals.startDateInitial && this.clearInput(), this.updateTimePickerDisplay(), this.updateInput(!1, !1), this.hideDropdown(a)
            }, this)), this.input.find(".calentim-apply").off("click.calentim").on("click.calentim", a.proxy(function(a) {
                this.config.startDate = this.config.startDate || moment(), this.config.endDate = this.config.endDate || moment(), !0 === this.config.onbeforeselect(this, this.config.startDate, this.config.endDate) && !0 === this.checkRangeContinuity() ? (this.globals.firstValueSelected = !0, this.globals.delayInputUpdate ? (this.globals.delayInputUpdate = !1, this.updateInput(!0, !1), this.globals.delayInputUpdate = !0) : this.updateInput(!0, !1)) : this.fetchInputs(), this.hideDropdown(a)
            }, this)))
        },
        addInitialEvents: function() {
            var d = "click.calentim";
            ...
            }, this)), this.config.enableKeyboard && (d = "click.calentim focus.calentim"), this.$elem.off(d).on(d, a.proxy(this.debounce(function(a) {
            ...
            }, 200, !0), this)), this.globals.isMobile && a(b).on("resize.calentim", a.proxy(function() {
                this.container.trigger("calentim:resize")
            }, this)), this.container.on("calentim:resize", a.proxy(function() {
                if (this.config.showCalendars) {
                    var c = this.input.find(".calentim-calendar:visible:first").innerHeight();
                    this.input.removeClass("calentim-input-top-reset");
                    c > this.input.find(".calentim-calendars").outerHeight() ? this.input.find(".calentim-calendars").css("min-height", c) : this.input.find(".calentim-calendars").css("max-height", c), this.input.position().top < 0 && this.input.addClass("calentim-input-top-reset"), a(b).width() > a(b).height() ? "flex" === this.input.css("display") && (this.input.find(".calentim-header:visible").length > 0 ? this.input.css("height", c + this.input.find(".calentim-header").outerHeight() + 2 + "px") : this.input.css("height", c + 2 + "px")) : this.input.css("height", "auto")
                } else this.input.css("height", "auto");
                this.updateTimePickerDisplay()
            }, this)), "none" !== this.input.css("display") && this.globals.isMobile && this.container.trigger("calentim:resize"), a(b).on("resize scroll", a.proxy(this.debounce(this.setViewport, 200, !1), this))
        },
        stopBubbling: function(a) {
            return "function" == typeof a.stopPropagation ? a.stopPropagation() : void 0 !== a.cancelBubble && (a.cancelBubble = !0), "function" == typeof a.preventDefault && a.preventDefault(), a.returnValue = !1, !1
        },
        ...
        destroy: function() {
            this.config.inline ? (this.input.remove(), this.globals.isMobile ? this.$elem.unwrap(".calentim-container-mobile") : this.$elem.unwrap(".calentim-container"), this.elem.type = "text") : this.container.remove(), a(c).off(this.globals.documentEvent), this.$elem.removeData("calentim")
        },
    ...
    }, e.defaults = e.prototype.defaults, a.fn.calentim = function(a) {
