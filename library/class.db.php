...

{
 ...
 public function creat_url( $creat_url )
  ...
  $creat_urled = str_replace(str_split('\\/:*?"<>|,.()'), '-', $creat_url);

            $creat_urled=str_replace(" ","-",$creat_urled);
			...
			$creat_urled=trim($creat_urled, "-");

			$creat_urled=strtolower($creat_urled);
